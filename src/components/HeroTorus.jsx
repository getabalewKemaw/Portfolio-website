...
function Laptop() {
  ...
  const [reactLogo, nodeLogo, threeLogo, tailwindLogo] = useTexture([
    "https://raw.githubusercontent.com/PKief/vscode-material-icon-theme/main/icons/react.png",
    "https://raw.githubusercontent.com/PKief/vscode-material-icon-theme/main/icons/nodejs.png",
    "https://raw.githubusercontent.com/PKief/vscode-material-icon-theme/main/icons/threejs.png",
    "https://raw.githubusercontent.com/PKief/vscode-material-icon-theme/main/icons/tailwind.png",
  ]);
      ...
      <Float speed={0.8} rotationIntensity={0.4} floatIntensity={0.8}>
        <group>
          ...
          >
            ...
            <Decal position={[-0.65, 0.065, 0.35]} rotation={[-Math.PI / 2, 0, -0.2]} scale={0.35} map={reactLogo} />
            <Decal position={[0.55, 0.065, -0.1]} rotation={[-Math.PI / 2, 0, 0.15]} scale={0.28} map={nodeLogo} />
            <Decal position={[0, 0.065, 0.55]} rotation={[-Math.PI / 2, 0, 0.3]} scale={0.26} map={tailwindLogo} />
          </RoundedBox>
          ...
          <group position={[0, 0.06, -0.8]} rotation={[openAngle, 0, 0]}>
            ...
            >
              <meshStandardMaterial color="#0b1220" metalness={0.55} roughness={0.35} />
              {/* Sticker on lid back */}
              <Decal position={[0.6, 0.8, 0.041]} rotation={[0, 0.2, 0]} scale={0.35} map={threeLogo} />
            </RoundedBox>

            {/* Screen (inside) */}
            <mesh position={[0, 0.8, -0.041]} castShadow>
              <planeGeometry args={[2.28, 1.44]} />
              <meshStandardMaterial color="#0b0f1a" emissive="#0b0f1a" emissiveIntensity={0.35} roughness={0.9} />
            </mesh>
          </group>
        </group>
      </Float>
...
export default function HeroTorus() {
  return (
    <div className="w-full h-64 sm:h-72 md:h-96 lg:h-[28rem]">
      <Canvas shadows dpr={[1, 2]} gl={{ antialias: true, alpha: true }} camera={{ position: [0, 0.4, 6], fov: 50 }}>
